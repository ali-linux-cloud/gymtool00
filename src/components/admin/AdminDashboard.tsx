...
import { Dumbbell, Users, ClipboardCheck, Ban } from 'lucide-react';
...
type TabType = 'renewals' | 'requests' | 'subscriptions' | 'rejected';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-8">
          ...
          {/* Navigation Tabs */}
          <div className="flex flex-wrap gap-2 rounded-xl bg-gray-800/50 p-1 mb-8">
            <button
